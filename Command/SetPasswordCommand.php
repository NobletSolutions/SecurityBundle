...
class SetPasswordCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this->setName('set_password')
            ...
            ->setDefinition(array(
                new InputArgument(
                    'user_email', InputArgument::REQUIRED, 'User email address'
                ),
                new InputArgument(
                    'class', InputArgument::REQUIRED, 'User class'
                ),
                new InputArgument(
                    'user_field', InputArgument::REQUIRED, 'User field'
                ),
                new InputArgument(
                    'newpass', InputArgument::REQUIRED, 'New Password'
                ),
        ));
    }
